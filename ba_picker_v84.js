// SLS Breakage Input v84 — centralized Print BA picker for SPV/Manager/Master.
(function(){
  'use strict';
  ...
  function canUse(){
    try{return !!ACCESS?.can_submit_approve || !!ACCESS?.is_manager || !!ACCESS?.is_master;}catch(_){return false;}
  }
  function scopeRdc(){
      ...
      <div id="baPickerModal" class="overlay">
        <div class="modal" style="width:min(760px,100%)">
          ...
          <div class="modal-body">
            <div class="hint"><b>Filter BA Pengiriman</b><br>Tanggal boleh dikosongkan untuk menampilkan seluruh BA dalam scope RDC. Gunakan Search untuk mencari No BA, No SJ, Customer, Vendor, atau No Polisi.</div>
            <div class="form-grid" style="margin-top:10px">
              <div class="field"><label>Tanggal Pengiriman / Kejadian</label><input id="baPickerDate" type="date"></div>
              <div class="field"><label>Search</label><input id="baPickerSearch" type="search" placeholder="Cari BA / SJ / customer / vendor / polisi"></div>
  ...
  // Centralize SPV print access: keep direct post-save print for Operator, but remove per-row/review print clutter for SPV/manager/master.
  ...
  function setBuild(){const b=el('buildBadge');if(b)b.textContent='v84';}
